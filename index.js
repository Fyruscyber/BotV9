...
const instagram = 'https://instagram.com/IndraFajri64'; 
...
//const grupch1 = 'https://chat.whatsapp.com/KvnrobWpHgXEKqYwzQMTTi'; 
//const grupch2 = 'https://chat.whatsapp.com/J3jbu1Bo72CAUYNMGm6wbA' ; 
const
{
   WAConnection,
   MessageType,
...
axios.get(`https://quran.kemenag.go.id/=${teks}`).then((res) => {
    let hasil = `Ayat : ${ayat}\nIsi : ${isi}\nLink : ${link}\n\n HALELUYA TUHAN YESUS MEMBERKATI KITA SEMUA`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
